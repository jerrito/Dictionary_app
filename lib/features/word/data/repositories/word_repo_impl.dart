...
class WordSuggestionRepositoryImpl implements WordSuggestionRepository{
  ...
  @override
  Future<Either<String, List<dynamic>>> suggestWords({required Map<String, dynamic> params}) async{
  try{
    final response=await wordLocalDatasource.suggestWords(params: params, );
